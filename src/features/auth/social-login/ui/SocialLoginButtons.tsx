...
export function SocialLoginButtons({
  ...
  const btnClass =
    "w-full gap-2 border-zinc-700/90 bg-[#121214] py-2.5 text-sm font-medium text-white hover:bg-zinc-800/80 hover:text-white focus:ring-[#a855f7]/40";
    ...
    <div className="mt-8 w-full space-y-4">
      <div className="relative">
        ...
        <div className="relative flex justify-center text-[10px] font-semibold uppercase tracking-[0.2em] text-zinc-500">
          <span className="bg-[#161618] px-3">{dividerLabel}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2.5">
        ...
        <Button
          type="button"
          variant="outline"
          onClick={() => void handleSocialLogin("monkeytype")}
          disabled={isLoading !== null}
          isLoading={isLoading === "monkeytype"}
          className={btnClass}
        >
          <KeyboardIcon className="h-4 w-4 shrink-0" />
          Monkeytype
        </Button>
        ...
        <Button
          type="button"
          variant="outline"
          onClick={() => void handleSocialLogin("leetcode")}
          disabled={isLoading !== null}
          isLoading={isLoading === "leetcode"}
          className={btnClass}
        >
