...
const PARAGRAPHS = [
  ...
  "At its core, MetaCode provides a personalized profile where users can monitor their activity across multiple platforms such as GitHub, LeetCode, and typing tools. This unified view allows developers to better understand their progress, identify gaps, and maintain consistency in their daily practice. By aggregating data from different sources, the platform transforms scattered efforts into a clear and measurable development journey.",
